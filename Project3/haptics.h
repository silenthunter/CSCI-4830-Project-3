...
void cubeContact();
//brings in values to generate forces
void forceDirection(Vector3 unitVector, double magnitude);
private: 
...
//Magnitude of graphics vector
double magnitudeVectorGraphic;
//unit vector, direction of deflection
Vector3 unitVectorGraphic;
//Array to average unit vectors
double unitVectorStorage[10][3];
